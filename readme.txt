...
3. **Choix du nombre de publication affichées** : Le plugin supprime la limite de publication maximales affichées à l'écran (vous pouvez mettre + de 999 publications dans Options de l'écran)
...
1. **Téléchargez le fichier ZIP du plugin :**
   ...
   Depuis la page de WP Instant Search, téléchargez le fichier ZIP du plugin.
